...
function VedioCard({video,setDeleteVideoResponse,insideCategory}) {
  ...
  const handleShow = async () => {
    setShow(true);
    //generate data to store inhistory
  ...
  return (
   <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body><iframe className='w-100' height="387" src={`${video?.link}?autoplay=1`} title={video?.caption}  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></Modal.Body>
      </Modal>
   </>
  )
}
